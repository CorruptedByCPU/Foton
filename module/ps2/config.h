...
===============================================================================*/
	...
	#define	MODULE_PS2_STATUS_output			0x01
	#define	MODULE_PS2_STATUS_input				0x02
	#define	MODULE_PS2_STATUS_output_second			0x20

	#define	MODULE_PS2_CONFIGURATION_PORT_SECOND_INTERRUPT	0x02
	#define	MODULE_PS2_CONFIGURATION_PORT_SECOND_CLOCK	0x20
	...
	#define	MODULE_PS2_MOUSE_PACKET_LMB			0x01
	#define	MODULE_PS2_MOUSE_PACKET_RMB			0x02
	#define	MODULE_PS2_MOUSE_PACKET_MMB			0x04
	#define	MODULE_PS2_MOUSE_PACKET_ALWAYS_ONE		0x08
	#define	MODULE_PS2_MOUSE_PACKET_X_SIGNED		0x10
	#define	MODULE_PS2_MOUSE_PACKET_Y_SIGNED		0x20
	#define	MODULE_PS2_MOUSE_PACKET_OVERFLOW_x		0x40
	#define	MODULE_PS2_MOUSE_PACKET_OVERFLOW_y		0x80
