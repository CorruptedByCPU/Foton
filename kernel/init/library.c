...
void kernel_init_library( void ) {
	...
	kernel -> library_base_address = (struct KERNEL_STRUCTURE_LIBRARY *) kernel_memory_alloc( MACRO_PAGE_ALIGN_UP( KERNEL_LIBRARY_limit * sizeof( struct KERNEL_STRUCTURE_LIBRARY ) ) >> STD_SHIFT_PAGE );
