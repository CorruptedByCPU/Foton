...
===============================================================================*/
	...
	#define	KERNEL_LAPIC_SIV_FLAG_spurious_vector		0b00000000000000000000000011111111	// __asm__ volatile( "int 0xFF" );
	#define	KERNEL_LAPIC_LVT_TR_FLAG_mask_interrupts	0b00000000000000010000000000000000
	#define	KERNEL_LAPIC_TDC_divide_by_1			0b00000000000000000000000000000111
