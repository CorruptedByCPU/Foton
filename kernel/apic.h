...
===============================================================================*/
	...
	#define	KERNEL_APIC_SIV_FLAG_enable_apic	0x0100		// 0b00000000000000000000000100000000
	#define	KERNEL_APIC_SIV_FLAG_spurious_vector	0xFF		// 0b00000000000000000000000011111111	// __asm__ volatile( "int 0xFF" );

	#define	KERNEL_APIC_LVT_TR_FLAG_mask_interrupts	0xFFFF8000	// 0b00000000000000010000000000000000
	
	#define	KERNEL_APIC_TDC_divide_by_1		0x07		// 0b00000000000000000000000000000111
