...
struct LIB_ASM_STRUCTURE_INSTRUCTION lib_asm_instruction_master[] = {
	...
	{ EMPTY, (M) | (V) << LIB_ASM_OPTION_OPERAND_offset | FM | FV, lib_asm_instruction_group_1 },
	{ EMPTY },
...
struct LIB_ASM_STRUCTURE_INSTRUCTION lib_asm_instruction_slave[] = {
	...
	{ EMPTY },
	{ EMPTY },
	{ (uint8_t *) "imul", (M) << LIB_ASM_OPTION_OPERAND_offset | FM },
	// 0x0F 0xB0
	{ EMPTY },
	{ EMPTY },
	{ EMPTY },
	...
	{ EMPTY },
	{ EMPTY },
	{ (uint8_t *) "movzx", (M|B) << LIB_ASM_OPTION_OPERAND_offset | FM | F1 },
	{ (uint8_t *) "movzx", (M|W) << LIB_ASM_OPTION_OPERAND_offset | FM | F1 },
	{ EMPTY },
	{ EMPTY },
	{ EMPTY },
	{ EMPTY },
	...
	{ EMPTY },
	{ EMPTY },
	{ (uint8_t *) "movsx", (M|W) << LIB_ASM_OPTION_OPERAND_offset | FM | F1 },
	// 0x0F 0xC0
	{ EMPTY },
	{ EMPTY },
	{ EMPTY },
