...
#define	LIB_UI_COLOR_BACKGROUND_LIST_HOVER	LIB_UI_COLOR_BACKGROUND_DEFAULT + LIB_UI_COLOR_INCREASE_LITTLE
...
#define	LIB_UI_ELEMENT_LIST_ENTRY_height	LIB_FONT_HEIGHT_pixel
