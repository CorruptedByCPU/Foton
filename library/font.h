...
===============================================================================*/
	...
	#define	LIB_FONT
        ...
        // display management
	#define LIB_FONT_FLAG_ALIGN_left             	1
	#define LIB_FONT_FLAG_ALIGN_center           	2
	#define LIB_FONT_FLAG_ALIGN_right            	4
	#define LIB_FONT_FLAG_ALIGN_justify          	8
	#define	LIB_FONT_FLAG_WEIGHT_bold		16
