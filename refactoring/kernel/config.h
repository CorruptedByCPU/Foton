...
#define	KERNEL_STACK_address	(uintptr_t) -(KERNEL_STACK_LIMIT_page << STD_SHIFT_PAGE)	// minimal size
...
struct KERNEL {
	...
	volatile struct KERNEL_STRUCTURE_APIC			*lapic_base_address;
